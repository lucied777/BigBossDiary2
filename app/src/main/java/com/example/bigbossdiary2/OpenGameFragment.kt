...
import com.example.bigbossdiary2.databinding.FragmentOpenGameBinding
...
class OpenGameFragment : Fragment() ,AlertSaveDialog.OnAlertSaveListener {

    private lateinit var  realm : Realm
    private var _binding : FragmentOpenGameBinding? = null
    private val binding: FragmentOpenGameBinding get() = _binding!!
    ...
    private var leagueMode = 3 //オープン戦
    ...
    override fun onCreateView(
        ...
        _binding = FragmentOpenGameBinding.inflate(inflater,container,false)
